function imgVer(Config) {
    ...
    var left_Num = -X + 10;
    // 图形滑块验证码 DOM 生成
    var html = '<div style="position:relative;padding:16px 16px 28px;border:1px solid #ddd;background:#f2ece1;">';
    ...
    html += '</div>';
    html += '<br>';
    html += '<div style="position:relative;width:100%;margin:auto;">';
    html += '<div style="border:1px solid #c3c3c3;height:40px;border-radius:24px;background:#DFE1E2;box-shadow:0 1px 1px rgba(12,10,10,0.2) inset;">';
    html += '<p class="tuo" style="font-size:14px;color: #88949d;padding-left:70px;line-height:40px;height:100%;margin:0;">拖动滑块完成拼图</p>';
    html += '</div>';
